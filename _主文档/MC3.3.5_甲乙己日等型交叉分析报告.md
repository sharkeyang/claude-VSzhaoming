  ...
  - [六、操盘计划](#六操盘计划)
    ...
    - [6.7 第3层：工具汇总](#67-第3层工具汇总)
      ...
      - [6.7.3 垒升判断（柱体≥2%，§5.3）](#673-垒升判断柱体253)
        - [6.7.3.1 垒升判定：只在垒升位置介入](#6731-垒升判定只在垒升位置介入)
        - [6.7.3.2 持有策略：升连成群结队，可期待连续](#6732-持有策略升连成群结队可期待连续)
        - [6.7.3.3 启动信号：升吞转升连是最强启动（§5.3.6）](#6733-启动信号升吞转升连是最强启动536)
        - [6.7.3.4 跌连处理：DXZC\>0 跌连不成群结队（§5.3.5.2）](#6734-跌连处理dxzc0-跌连不成群结队5352)
        - [6.7.3.5 持续持有 vs 波段（§5.3.1.1）](#6735-持续持有-vs-波段5311)
        - [6.7.3.6 镜面映射的全局指导（§5.3.5.2）](#6736-镜面映射的全局指导5352)
...
##### 6.7.3.3 启动信号：升吞转升连是最强启动（§5.3.6）

看到"升吞"后，下一日若转升连（74.07%），**应重点介入**——这是最强启动信号，错过首日升吞后，次日转升连是补仓/介入的最佳时机。

##### 6.7.3.4 镜面映射的全局指导：先按 DXZC 分类，再按升连/跌连分类（§5.3.5.2）
