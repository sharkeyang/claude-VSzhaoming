...
- **DXAB正交初期回落DJA反弹：** 若属 DXAB 正交初期出现的回落 DJA，此时**很可能会出现反弹，特别是继续触顶形成垒升**——这是等2 的重要介入窗口（见 §6.8.5 汇总）。
...
- **DTZA=-2 第二柱阳柱：** 等6 若第二柱为阳柱，**有可能再次站上DJA**（21.98%）；但**因为未触顶，不是判断入管的情况**，仅作反弹关注。
...
|:--|:--|:--|:--|:--|
| **等1** | 升管起点 | 人排/升吞轻仓试仓；先观察诱多/出管惯性 | 第1柱跌孕/跌吞回避；回落跌破DJA止损 | 21-26% |
| **等2** | 升管早期 | 触顶+升排（升连/升吞）；正交初期回落DJA反弹（继续触顶形成垒升） | 未触顶+跌排回避；跌破DJA止损 | 19-24% |
| **等3** | 成熟升管 | **扩管>60+升排（58-76%）**；平管+触顶+升排 | 不触顶阳柱→管宽缩小→下破DJA止损 | 17-76% |
| **等4** | 出管/跌管 | 首下破反弹/第二柱阳柱（可能再站DJA但未触顶非入管）；整体回避 | 跌破DJA无反弹离场 | 20-23% |

> **核心结论：** 介入时机坐标 = **等3 扩管>60 + 升排** 是最强介入点（升连 76.49%）；等2 靠触顶增强；等1 需等待确认；等4 整体回避。**管宽哼JA（col23）是决定性维度**，扩管>60 时升排介入胜率极高。
