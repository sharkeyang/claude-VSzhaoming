...
| 变量 | 数学定义 | 含义 |
|:--|:--|:--|
| DXZA | P vs DJA（EMA5） | 微观 |
| DXZB | P vs DJB（EMA12） | 护级（短周期） |
| DXZC | P vs DJC（EMA26） | 隐含在 DXCD |
| DXCD | P、EMA26、EMA60 的排列 | 土质（中周期） |
| DXZE | P vs DJE（EMA120） | 大势（长周期） |
...
| DXCD | 数学条件 | 几何含义 |
|:--|:--|:--|
| **上** | P > JC > JD | 价格最高，完全多头排列 |
| **中** | JC > P > JD | 价格居中，均线多头 |
| **下** | JC > JD > P | 价格最低，均线多头但价格跌破 |
| **忐** | P > JD > JC | 价格最高，但均线空头 |
| **忠** | EMA60>DJZ>EMA26 | 价格在 EMA26 之上、EMA60 之下（均线空头）|
| **忑** | P < JD | 价格在 EMA60 之下，均线空头 |
