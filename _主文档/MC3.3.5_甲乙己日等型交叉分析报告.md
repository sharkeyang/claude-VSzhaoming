...
- 跌连大概率只有1天，**不必恐慌卖出**——DXZC>0 时跌连不成群，次日大概率转好。
- 但跌连当日介入优势不大（67.19%≈基线），**最好等转升排确认再介入**，不宜跌连当日重仓。
...
- **DXZC>0（阳区）：升连聚集、跌连可介入**——顺势做多，跌连是回调可低吸。
- **DXZC<0（阴区）：跌连聚集、升连不可追**——逆势回避，升连是反弹不可追高。
