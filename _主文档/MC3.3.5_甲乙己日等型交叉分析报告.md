...
- [四、柱与DJA三态理论 + 操作规则优化](#四柱与dja三态理论-操作规则优化)
    - [4.1 柱与DJA三态理论框架（用户理论，2026-09-10 验证）](#41-柱与dja三态理论框架用户理论2026-09-10-验证)
        - [2.9.1 三态定义](#291-三态定义)
    ...
    - [4.2 操作规则优化：升管/跌管思维（用户理论，2026-09-11 验证）](#42-操作规则优化升管跌管思维用户理论2026-09-11-验证)
...
- [五、操盘计划](#五操盘计划)
    - [5.1 核心框架：四层漏斗 + 真假正交识别](#51-核心框架四层漏斗-真假正交识别)
    - [5.2 介入点分类（按胜率与风险）](#52-介入点分类按胜率与风险)
    - [5.3 退出情况分类（按转坏信号强度，从轻到重）](#53-退出情况分类按转坏信号强度从轻到重)
    - [5.4 完整操盘流程（分情况指南）](#54-完整操盘流程分情况指南)
    - [5.5 与 5.3.3 位置决策表相互印证](#55-与-533-位置决策表相互印证)
    - [5.6 收益估算与风险提示](#56-收益估算与风险提示)
    - [5.7 DXAB 由负转正信号的综述](#57-dxab-由负转正信号的综述)
    - [5.8 四层漏斗定型操作规则（综合所有分析，2026-09-08 定稿，2026-09-12 统一为四层）](#58-四层漏斗定型操作规则综合所有分析2026-09-08-定稿2026-09-12-统一为四层)
- [六、周级别映射 + 微观指标](#六周级别映射-微观指标)
    - [6.1 周级别映射：日级别分析是否适用于周类（2026-09-08 验证）](#61-周级别映射日级别分析是否适用于周类2026-09-08-验证)
    - [6.2 微观指标验证：操作区域内各微观指标的获利性（2026-09-08 验证）](#62-微观指标验证操作区域内各微观指标的获利性2026-09-08-验证)
- [七、附录：数据口径说明](#七附录数据口径说明)
    - [7.1 样本与核心限定](#71-样本与核心限定)
    - [7.1.1 日等型定义（BT连阳列，2026-09-12 补充）](#711-日等型定义bt连阳列2026-09-12-补充)
    - [7.2 权威列映射（VBA导出程序，2026-09-10 建立）](#72-权威列映射vba导出程序2026-09-10-建立)
...
### 4.1 柱与DJA三态理论框架（用户理论，2026-09-10 验证）
...
### 4.2 操作规则优化：升管/跌管思维（用户理论，2026-09-11 验证）
...
### 5.8 四层漏斗定型操作规则（综合所有分析，2026-09-08 定稿，2026-09-12 统一为四层）
...
### 6.1 周级别映射：日级别分析是否适用于周类（2026-09-08 验证）
...
### 6.2 微观指标验证：操作区域内各微观指标的获利性（2026-09-08 验证）
...
### 7.1.1 日等型定义（BT连阳列，2026-09-12 补充）
...
### 7.2 权威列映射（VBA导出程序，2026-09-10 建立）
