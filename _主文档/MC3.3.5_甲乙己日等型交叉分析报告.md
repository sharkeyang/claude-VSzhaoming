...
| **管中** | 扩管（管宽>60，连升推高顶）/平管（管宽0~60，平移/阴阳交错）/窄管（管宽<0，无有效上涨）| 镜面 |
...
> **管宽分类铁律（2026-09-20 用户纠正）：** 扩管/平管/窄管**必须用管宽哼JA（col23）**，不是宽哼JC（col24）。**窄管 = 0 < 管宽哼JA < 5**；**管宽≥5 时看柱排是否推高顶（推高顶=触顶+升排）——推高顶=扩管，非推高顶=平管**。管宽哼JA 只在升管（日ZA>0）时有值。
