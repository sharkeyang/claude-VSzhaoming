...
'========================================================================================
    ...
    '---------------------------------------------
    With 菜栏.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎瓜页前调决策按B月护周护"
        .Caption = "月护周护"
        .FaceId = 450 '340
        .Style = msoButtonIconAndCaptionBelow
    End With
    With 菜栏.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎瓜页前调决策按B月护周地"
        .Caption = "月护周地"
        .FaceId = 450 '340
        .Style = msoButtonIconAndCaptionBelow
    End With
    With 菜栏.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎瓜页前调决策按B月护周层"
        .Caption = "月护周层"
        .FaceId = 450 '340
        .Style = msoButtonIconAndCaptionBelow
    End With
    With 菜栏.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎瓜页前调决策按B周护周层"
        .Caption = "周护周层"
        .FaceId = 450 '340
        .Style = msoButtonIconAndCaptionBelow
    End With
    With 菜栏.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎瓜页前调决策按B月护日层"
        .Caption = "月护日层"
        .FaceId = 450 '340
        .Style = msoButtonIconAndCaptionBelow
    End With
...
'    End With
'    With 菜栏.Controls.Add(Type:=msoControlButton)
'        .OnAction = "IQQQ展擎瓜页前调决策按B日乾日层滤"
'        .Caption = "日乾日层滤"
'        .FaceId = 450 '340
'        .Style = msoButtonIconAndCaptionBelow
'    End With
'    With 菜栏.Controls.Add(Type:=msoControlButton)
'        .OnAction = "IQQQ展擎瓜页前调决策按B日乾日机"
'        .Caption = "日乾日机"
'        .FaceId = 450 '340
'        .Style = msoButtonIconAndCaptionBelow
'    End With
...
'    End With
    ...
    End With
'    With 菜栏.Controls.Add(Type:=msoControlButton)
'        .OnAction = "IQQQ展擎主前调_cCCC式频谱日类视角"
'        .Caption = "谱c"
'        .FaceId = 719 '772 '486
'        .Style = msoButtonIconAndCaptionBelow
'        .TooltipText = "cCCC式频谱日类视角"
'    End With
    With 菜栏.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sSCC式频谱日类视角"
        .Caption = "谱s"
        .FaceId = 719 '772 '486
        .Style = msoButtonIconAndCaptionBelow
        .TooltipText = "sSCC式频谱日类视角"
    End With
    '---------------------------------------------
    With 菜栏.Controls.Add(Type:=msoControlButton)
        .OnAction = "现市单程_全局全球"
...
''    '由选择框导入
''    With 菜项池.Controls.Add(Type:=msoControlButton)
''        .OnAction = "STBASE池管理_表导入调程由选择文件池金"
''        .Caption = "导入池 金"
''        .FaceId = 271  '22 '42
''    End With
''    With 菜项池.Controls.Add(Type:=msoControlButton)
''        .OnAction = "STBASE池管理_表导入调程由选择文件池银"
''        .Caption = "导入池 银"
''        .FaceId = 271  '22 '42
''    End With
''    With 菜项池.Controls.Add(Type:=msoControlButton)
''        .OnAction = "STBASE池管理_表导入调程由选择文件池铜"
''        .Caption = "导入池 非"
''        .FaceId = 271  '22 '42
''    End With
''    With 菜项池.Controls.Add(Type:=msoControlButton)
''        .OnAction = "STBASE池管理_表导入调程由选择文件池黑"
''        .Caption = "导入池 黑"
''        .FaceId = 271  '22 '42
''    End With
'========================================================================================
...
'========================================================================================
    ...
    End With
'    With 菜项结算.Controls.Add(Type:=msoControlButton)
'        .OnAction = "STCALL花册工具_快照导入花天"
'        .Caption = "花册快照导入"
'        .FaceId = 111 ' 207
'    End With
'    With 菜项结算.Controls.Add(Type:=msoControlButton)
'        .OnAction = "STCALL花册工具_快照导出花天"
'        .Caption = "花册快照导出"
'        .FaceId = 110 ' 207
'    End With
    '-------------------------------------------------
    With 菜项结算.Controls.Add(Type:=msoControlButton)
        .OnAction = "STCALL花册工具_控制显示花天"
        .Caption = "花册显隐"
        .FaceId = 223 ' 207
    End With
    '-------------------------------------------------
...
'    End With
'    With 菜项结算.Controls.Add(Type:=msoControlButton)
'        .OnAction = "UGSOP全局昭明方舟_入方舟"
'        .Caption = "建方舟"
'        .FaceId = 878 ' 207
'    End With
'    With 菜项结算.Controls.Add(Type:=msoControlButton)
'        .OnAction = "UGSOP全局昭明方舟_出方舟"
'        .Caption = "出方舟"
'        .FaceId = 878 ' 207
'    End With
'========================================================================================
...
'========================================================================================
    ...
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
        .OnAction = "STBASE结算管理_VScode下载调程_中期"
        .Caption = "下载数据+全新结算"
        .FaceId = 372 '157 '967 '308
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
    ...
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ乾坤分布调程花中期cCCC详按日乾日层"
        .Caption = "cCCC详按日乾日层 中期"
        .FaceId = 226 '809 '732 '449 '1005 '1648 '1809 '37
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ乾坤分布调程花中期cCCC详按月护周波"
        .Caption = "cCCC详按月护周波 中期"
        .FaceId = 226 '809 '732 '449 '1005 '1648 '1809 '37
    End With
    '------------------------------------------------------------------------------------
    '模块：外盘管理 港股指
    ...
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
        .OnAction = "STBASE结算管理_VScode下载调程_港股指"
        .Caption = "下载数据+全新结算"
        .FaceId = 372 '157 '967 '308
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
    ...
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ乾坤分布调程花港股指sSCC详按日乾日层"
        .Caption = "sSCC简按日乾日层 港股指"
        .FaceId = 226 '809 '732 '449 '1005 '1648 '1809 '37
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ乾坤分布调程花港股指sSCC详按月护周波"
        .Caption = "sSCC简按月护周层 港股指"
        .FaceId = 226 '809 '732 '449 '1005 '1648 '1809 '37
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ乾坤分布调程花港股指cCCC详按日乾日层"
        .Caption = "cCCC简按日乾日层 港股指"
        .FaceId = 226 '809 '732 '449 '1005 '1648 '1809 '37
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ乾坤分布调程花港股指cCCC详按月护周波"
        .Caption = "cCCC简按月护周层 港股指"
        .FaceId = 226 '809 '732 '449 '1005 '1648 '1809 '37
    End With
    '------------------------------------------------------------------------------------
    '模块：外盘管理 港股通
    ...
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
        .OnAction = "STBASE结算管理_VScode下载调程_港股通"
        .Caption = "下载数据+全新结算"
        .FaceId = 372 '157 '967 '308
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
    ...
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ乾坤分布调程花港股通sSCC详按日乾日层"
        .Caption = "sSCC详按日乾日层 港股通"
        .FaceId = 226 '809 '732 '449 '1005 '1648 '1809 '37
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ乾坤分布调程花港股通sSCC详按月护周波"
        .Caption = "sSCC详按月护周波 港股通"
        .FaceId = 226 '809 '732 '449 '1005 '1648 '1809 '37
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ乾坤分布调程花港股通cCCC详按日乾日层"
        .Caption = "cCCC简按日乾日层 港股通"
        .FaceId = 226 '809 '732 '449 '1005 '1648 '1809 '37
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ乾坤分布调程花港股通cCCC详按月护周波"
        .Caption = "cCCC简按月护周层 港股通"
        .FaceId = 226 '809 '732 '449 '1005 '1648 '1809 '37
    End With
   '------------------------------------------------------------------------------------
    '模块：外盘管理 美股
    ...
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
        .OnAction = "STBASE结算管理_VScode下载调程_美股票"
        .Caption = "下载数据+全新结算"
        .FaceId = 372 '157 '967 '308
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
    ...
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ乾坤分布调程花美股票cCCC详按日乾日层"
        .Caption = "cCCC简按日乾日层 美股"
        .FaceId = 226 '809 '732 '449 '1005 '1648 '1809 '37
    End With
    With 菜项外盘.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ乾坤分布调程花美股票cCCC详按月护周波"
        .Caption = "sSCC详按月护周波 美股"
        .FaceId = 226 '809 '732 '449 '1005 '1648 '1809 '37
    End With
'========================================================================================
'菜项算比
'========================================================================================
    ...
    With 菜项算比.Controls.Add(Type:=msoControlButton)
        .OnAction = "XL算比前调_粗比按周快速"
        .Caption = "粗比按周 快速"
        .FaceId = 772 '588 '7
    End With
    With 菜项算比.Controls.Add(Type:=msoControlButton)
        .OnAction = "XL算比前调_粗比按日快速"
        .Caption = "粗比按日 快速"
        .FaceId = 772 '588 '7
    End With
    '------------------------------------------------------------------------------------
    ...
    With 菜项算比.Controls.Add(Type:=msoControlButton)
        .OnAction = "XL算比前调_粗比按周"
        .Caption = "粗比按周"
        .FaceId = 772 '588 '7
    End With
    With 菜项算比.Controls.Add(Type:=msoControlButton)
        .OnAction = "XL算比前调_粗比按日"
        .Caption = "粗比按日"
        .FaceId = 772 '588 '7
    End With
    '------------------------------------------------------------------------------------
    ...
    With 菜项算比.Controls.Add(Type:=msoControlButton)
        .OnAction = "XL算比前调_精比按周"
        .Caption = "精比按周"
        .FaceId = 772 '588 '7
    End With
    With 菜项算比.Controls.Add(Type:=msoControlButton)
        .OnAction = "XL算比前调_精比按日"
        .Caption = "精比按日"
        .FaceId = 772 '588 '7
    End With
    '------------------------------------------------------------------------------------
    ...
    End With
    With 菜项算比.Controls.Add(Type:=msoControlButton)
        .OnAction = "XL历研阶析前调_市板Q6"
        .Caption = "历研阶析 Q6"
        .FaceId = 588 '7
    End With
    With 菜项算比.Controls.Add(Type:=msoControlButton)
        .OnAction = "XL历研阶析前调_市板Q0"
        .Caption = "历研阶析 Q0"
        .FaceId = 588 '7
    End With
    With 菜项算比.Controls.Add(Type:=msoControlButton)
        .OnAction = "XL历研阶析前调_市板Q3"
        .Caption = "历研阶析 Q3"
        .FaceId = 588 '7
    End With
    With 菜项算比.Controls.Add(Type:=msoControlButton)
        .OnAction = "XL历研阶析前调_市板Q8"
        .Caption = "历研阶析 Q8"
        .FaceId = 588 '7
    End With
    With 菜项算比.Controls.Add(Type:=msoControlButton)
        .OnAction = "XL历研阶析前调_市板Qo"
        .Caption = "历研阶析 Qo"
        .FaceId = 588 '7
    End With
'
...
'========================================================================================
    ...
    End With
'    With 菜项算展.Controls.Add(Type:=msoControlButton)
'        .OnAction = "XL算展前调_周_s均权"
'        .Caption = "周 s均权"
'        .FaceId = 772 '588 '7
'    End With
'    With 菜项算展.Controls.Add(Type:=msoControlButton)
'        .OnAction = "XL算展前调_周_T均ZC"
'        .Caption = "周 T均ZC"
'        .FaceId = 772 '588 '7
'    End With
'    With 菜项算展.Controls.Add(Type:=msoControlButton)
'        .OnAction = "XL算展前调_周_s山丘"
'        .Caption = "周 s山丘"
'        .FaceId = 772 '588 '7
'    End With
'    With 菜项算展.Controls.Add(Type:=msoControlButton)
'        .OnAction = "XL算展前调_周_T山丘"
'        .Caption = "三期 T山丘"
'        .FaceId = 772 '588 '7
'    End With
'    With 菜项算展.Controls.Add(Type:=msoControlButton)
'        .OnAction = "XL算展前调_周_T乾坤"
'        .Caption = "三期 T乾坤"
'        .FaceId = 772 '588 '7
'    End With
'    '------------------------------------------------------------------------------------
...
'    End With
    ...
    End With
'    With 菜项算展.Controls.Add(Type:=msoControlButton)
'        .OnAction = "XL算展前调_日_s均权"
'        .Caption = "日 s均权"
'        .FaceId = 772 '588 '7
'    End With
'    With 菜项算展.Controls.Add(Type:=msoControlButton)
'        .OnAction = "XL算展前调_日_s山丘"
'        .Caption = "日 s山丘"
'        .FaceId = 772 '588 '7
'    End With
    '------------------------------------------------------------------------------------
...
'    End With
    ...
    End With
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sCCC式决策简按月护日层"
        .Caption = "sCCC式决策简按月护日层"
        .FaceId = 226 '772 '486
    End With
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sCCC式决策简按月护周波"
        .Caption = "sCCC式决策简按月护周波"
        .FaceId = 226 '772 '486
    End With
    '------------------------------------------------------------------------------------
    '------------------------------------------------------------------------------------
...
'    End With
    '-------------------------------------------------------
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_cCCC式决策简按月护日层"
        .Caption = "cCCC式决策简按月护日层"
        .FaceId = 226 '772 '486
    End With
'    With 菜项决策.Controls.Add(Type:=msoControlButton)
'        .OnAction = "IQQQ展擎主前调_cCCC式决策详按月护日层"
'        .Caption = "cCCC式决策详按月护日层"
'        .FaceId = 226 '772 '486
'    End With
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_cCCC式决策详按月护日层外簿"
        .Caption = "cCCC式决策详按月护日层 外簿"
        .FaceId = 226 '772 '486
    End With
    '-------------------------------------------------------
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_cCCC式决策简按月护周波"
        .Caption = "cCCC式决策简按月护周波"
        .FaceId = 226 '772 '486
    End With
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_cCCC式决策详按月护周波"
        .Caption = "cCCC式决策详按月护周波"
        .FaceId = 226 '772 '486
    End With
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_cCCC式决策详按月护周波外簿"
        .Caption = "cCCC式决策详按月护周波 外簿"
        .FaceId = 226 '772 '486
    End With
    '-------------------------------------------------------
'    With 菜项决策.Controls.Add(Type:=msoControlButton)
...
'    End With
    '-------------------------------------------------------
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sSCC式决策简按月护日层"
        .Caption = "sSCC式决策简按月护日层"
        .FaceId = 226 '772 '486
    End With
'    With 菜项决策.Controls.Add(Type:=msoControlButton)
'        .OnAction = "IQQQ展擎主前调_sSCC式决策详按月护日层"
'        .Caption = "sSCC式决策详按月护日层"
'        .FaceId = 226 '772 '486
'    End With
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sSCC式决策详按月护日层外簿"
        .Caption = "sSCC式决策详按月护日层 外簿"
        .FaceId = 226 '772 '486
    End With
    '-------------------------------------------------------
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sSCC式决策简按月护周波"
        .Caption = "sSCC式决策简按月护周波"
        .FaceId = 226 '772 '486
    End With
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sSCC式决策详按月护周波"
        .Caption = "sSCC式决策详按月护周波"
        .FaceId = 226 '772 '486
    End With
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sSCC式决策详按月护周波外簿"
        .Caption = "sSCC式决策详按月护周波 外簿"
        .FaceId = 226 '772 '486
    End With
    '-------------------------------------------------------
'    With 菜项决策.Controls.Add(Type:=msoControlButton)
...
'    End With
    '-------------------------------------------------------
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sSSC式决策简按月护日层"
        .Caption = "sSSC式决策简按月护日层"
        .FaceId = 226 '772 '486
    End With
'    With 菜项决策.Controls.Add(Type:=msoControlButton)
'        .OnAction = "IQQQ展擎主前调_sSSC式决策详按月护日层"
'        .Caption = "sSSC式决策详按月护日层"
'        .FaceId = 226 '772 '486
'    End With
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sSSC式决策详按月护日层外簿"
        .Caption = "sSSC式决策详按月护日层 外簿"
        .FaceId = 226 '772 '486
    End With
    '-------------------------------------------------------
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sSSC式决策简按月护周波"
        .Caption = "sSSC式决策简按月护周波"
        .FaceId = 226 '772 '486
    End With
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sSSC式决策详按月护周波"
        .Caption = "sSSC式决策详按月护周波"
        .FaceId = 226 '772 '486
    End With
    With 菜项决策.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sSSC式决策详按月护周波外簿"
        .Caption = "sSSC式决策详按月护周波 外簿"
        .FaceId = 226 '772 '486
    End With
'    '------------------------------------------------------------------------------------
'    '------------------------------------------------------------------------------------
...
'
'    With 菜项决策.Controls.Add(Type:=msoControlButton)
'        .OnAction = "IQQQ展擎主前调_sSSS式决策简按月护周波"
'        .Caption = "sSSS式决策简按月护周波"
'        .FaceId = 226 '772 '486
'    End With
'    With 菜项决策.Controls.Add(Type:=msoControlButton)
'        .OnAction = "IQQQ展擎主前调_sSSS式决策简按混日层"
'        .Caption = "sSSS式决策简按月护日层"
'        .FaceId = 226 '772 '486
'    End With
'    With 菜项决策.Controls.Add(Type:=msoControlButton)
'        .OnAction = "IQQQ展擎主前调_sSSS式决策详按月护周波"
'        .Caption = "sSSS式决策详按月护周波"
'        .FaceId = 226 '772 '486
'    End With
'    With 菜项决策.Controls.Add(Type:=msoControlButton)
'        .OnAction = "IQQQ展擎主前调_sSSS式决策详按月护日层"
'        .Caption = "sSSS式决策详按月护日层"
'        .FaceId = 226 '772 '486
'    End With
'    With 菜项决策.Controls.Add(Type:=msoControlButton)
'        .OnAction = "IQQQ展擎主前调_sSSS式决策详按月护日层外簿"
'        .Caption = "sSSS式外簿"
'        .FaceId = 226 '772 '486
'    End With
    '------------------------------------------------------------------------------------
...
'========================================================================================
    ...
    End With
    With 菜项频谱.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_cCCC式频谱周类视角"
        .Caption = "cCCC 频谱周类"
        .FaceId = 226 '772 '486
    End With
    '------------------------------------------------------------------------------------
    ...
    End With
    With 菜项频谱.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sSCC式频谱周类视角"
        .Caption = "sSCC 频谱周类"
        .FaceId = 226 '772 '486
    End With
    '------------------------------------------------------------------------------------
    ...
    End With
    With 菜项频谱.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sSSC式频谱日类视角"
        .Caption = "sSSC 频谱日类"
        .FaceId = 226 '772 '486
    End With
    With 菜项频谱.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sSSC式频谱周类视角"
        .Caption = "sSSC 频谱周类"
        .FaceId = 226 '772 '486
    End With
    '------------------------------------------------------------------------------------
    ...
    End With
    With 菜项频谱.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sSSS式频谱日类视角"
        .Caption = "sSSS 频谱日类"
        .FaceId = 226 '772 '486
    End With
    With 菜项频谱.Controls.Add(Type:=msoControlButton)
        .OnAction = "IQQQ展擎主前调_sSSS式频谱周类视角"
        .Caption = "sSSS 频谱周类"
        .FaceId = 226 '772 '486
    End With
'========================================================================================
...
'    End With
    ...
    '--------------------------------------------------
'    With 菜项现市.Controls.Add(Type:=msoControlButton)
'        .OnAction = "现市单程降序_中股精分系列国证"
'        .Caption = "CN 国证"
'        .FaceId = 105
'    End With
    With 菜项现市.Controls.Add(Type:=msoControlButton)
        .OnAction = "现市单程降序_中股精分系列中证"
        .Caption = "CN 中证"
        .FaceId = 105
    End With
    '------------------------------------------------------------------------------------
