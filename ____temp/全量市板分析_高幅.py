...
with open('____temp/board_full_analysis_hr.txt', 'w', encoding='utf-8') as f:
    f.write(result)
print(f'\n结果已保存: ____temp/board_full_analysis_hr.txt')