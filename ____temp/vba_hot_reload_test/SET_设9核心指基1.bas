...
'核心行业ETF - 板块轮动协同分组
'========================================================================================
' 分类依据（基于近1年日收益率相关系数 r，241个交易日）：
'
' 科技一(数字科技): 人工智能AIETF + 软件ETF + 数据ETF
'   组内r=0.88, 数据/云计算/信息安全/计算机四者r>0.94仅保留数据
'   人工智能AIETF与科技二r=0.50(独立风格)
'
' 科技二(数字传媒): 游戏ETF + 传媒ETF
'   组内r=0.85, 影视ETF量与传媒r=0.86但量太小(0.4万手/日)去掉
'   科技一vs科技二跨组r=0.65, 当日同涨同跌概率65%, 共享前缀
'
' 新科技: 半导体ETF + 通信ETF
'   两者与任何组r<0.35, 独立组, 同属硬科技基础设施
'
' 消费一(酒食旅): 酒ETF + 食品ETF + 旅游ETF, 组内r=0.71
' 消费二(医药): 创新药ETF + 医疗ETF, 组内r=0.88
' 消费四(畜牧农业): 畜牧ETF + 农业ETF, 组内r=0.90
'   消费三(影视传媒游戏)移出消费, 与消费类r<0.2, 与科技类r>0.7
'
' 金融: 银行ETF + 金融ETF + 证券保险ETF, 组内r=0.66
'
' 周期: 煤炭ETF + 稀土ETF + 钢铁ETF + 建材ETF + 油气ETF + 有色金属ETF
'   原工业甲拆出, 绿色电力+基建移入公用
'   国证油气/国证有色替换为ETF(跟踪r>0.98)
'
' 公用: 绿色电力ETF + 基建ETF, 原工业甲拆出
'
' 制造: 机床ETF + 机器人ETF + 高端装备ETF + 军工ETF + 光伏50ETF + 电池ETF
'   航空航天ETF与军工ETF r=0.95, 子集关系, 保留军工
'   中证新能(指数)替换为电池ETF
'
' 海外: 恒生ETF + 恒生互联 + 中概互联 + 恒H股ETF
'       + 港股通金融ETF + 恒生医疗 + 纳指ETF
'
' 注释掉的标的:
'   云计算ETF(sh516510) - 与数据ETF r=0.94
'   信息安全ETF(sz159613) - 与数据ETF r=0.96, 量最小
'   计算机ETF(sz159998/sh512720) - 与数据ETF r=0.96
'   影视ETF(sh516620) - 与传媒ETF r=0.86, 量太小
'   航空航天ETF(sh563380) - 与军工ETF r=0.95, 子集
'   电子50ETF(sh515320) - 与任何组r=0.5~0.65, 无归属
'   国证油气(sz399439) - 指数, 有油气ETF替代
'   国证有色(sz399395) - 指数, 有色金属ETF已取消注释
'   中证新能(sz399808) - 指数, 有电池ETF替代
'========================================================================================
With 典码称
'    '--------------------------------------------------------------
'    '宽基
...
'========================================================================================
    ...
    .Add key:="sz159745", Item:="建材ETF"
'========================================================================================
'没有上升趋势、反弹、回落等分类，统一按行业分组
'========================================================================================
    '--------------------------------------------------------------
    '制造：光伏·电池·机床·机器人·高端装备·军工
    '--------------------------------------------------------------
