...
#### 5.1.4 入管判定（旧准则）：DTZA≥3（2026-09-10 验证）

> **⚠️ 此为准入管判定（DTZA≥3），已被 §5.1.5 新准则（触哼入管）替代。保留作对比。**
>
...
> **🔗 本章结论 → 第六章入口：** 柱与DJA三态理论 + 操作规则优化是第六章"操作理念"（§6.8.12）的直接数据支撑——**升管（DTZA≥3，§6.8.9）、垒升（柱体≥2%，§5.3）、剔诱多（跌连-非触顶，§6.8.7.3）、不破DJB不出（DXZB退出规则，§5.2.9）** 正是 §6.8.12 操作理念（沃土→甲乙己不破DJB→升管→垒升→剔诱多）的微观层。**本章是第六章操作理念的"微观细节库"。**
