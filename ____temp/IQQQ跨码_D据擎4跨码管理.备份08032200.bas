...
'========================================================================================
    ...
    WSTO.Cells(大盘行, 2).Value = "≤" & Format(总上限, "0%") & "," & Round(福上限, 1)
    WSTO.Cells(大盘行, 3).Value = Round(福仓额, 1) & "(" & IIf(福仓额 <= 福上限, "达标", "超额") & ")"
    ...
    WSTO.Rows(大盘行).Font.Bold = True
    大盘行 = 19
    WSTO.Cells(大盘行, 1).Value = "  ├─月基(≥20%)"
    WSTO.Cells(大盘行, 2).Value = "≥" & Format(总上限 * 0.2, "0%") & "," & Round(福月基目标, 1)
    ...
    WSTO.Cells(大盘行, 2).Value = "≤" & Format(总上限 * 0.4, "0%") & "," & Round(福周冲目标, 1)
    ...
    WSTO.Cells(大盘行, 2).Value = "≤" & Format(总上限 * 0.4, "0%") & "," & Round(福日冲目标, 1)
    ...
    WSTO.Cells(大盘行, 4).Value = "≤" & Format(总上限, "0%") & "," & Round(彦上限, 1)
    WSTO.Cells(大盘行, 5).Value = Round(彦仓额, 1) & "(" & IIf(彦仓额 <= 彦上限, "达标", "超额") & ")"
    ...
    WSTO.Cells(大盘行, 4).Value = "≥" & Format(总上限 * 0.5, "0%") & "," & Round(彦月基目标, 1)
    ...
    WSTO.Cells(大盘行, 4).Value = "≤" & Format(总上限 * 0.5, "0%") & "," & Round(彦周冲目标, 1)
    ...
    WSTO.Cells(大盘行, 4).Value = "≤" & Format(总上限 * 0.2, "0%") & "," & Round(彦日冲目标, 1)
...
'========================================================================================
    ...
    If 缺行业名单 <> "" Then
        ...
        末行 = 末行 + 1
    End If
    WSTO.Rows(31).RowHeight = 20  '行业表头行高
'========================================================================================
'输出：三、策略分布
'========================================================================================
    末行 = 末行 + 1
