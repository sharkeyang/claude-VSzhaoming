...
Public 副本花册路径 As String
Public 副本藏库路径 As String
Public 后台运行 As Boolean
'########################################################################################
'########################################################################################
'##############################     通用外簿引擎     ####################################
'########################################################################################
...
Function STBASE外簿引擎_打开(簿令 As Excel.Workbook, ByVal 簿名全径 As String, Optional 是否后台 As Boolean = False) As Boolean
    ...
    If 副本花册路径 <> "" And 簿名全径 = 常外簿花册 Then
        簿名全径 = 副本花册路径
    ElseIf 副本藏库路径 <> "" And 簿名全径 = 常外簿藏库 Then
        簿名全径 = 副本藏库路径
    End If
    STBASE外簿引擎_打开 = False
...
'========================================================================================
Sub STBASE外簿引擎_设置副本路径(花册路径 As String, 藏库路径 As String)
    副本花册路径 = 花册路径
    副本藏库路径 = 藏库路径
    后台运行 = True
End Sub
