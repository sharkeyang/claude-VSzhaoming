...
'========================================================================================
    ...
    '锁定时点：分析审计
    '------------------------------------------------------------------------------------
    Dim 菜项审计 As CommandBarPopup
    Set 菜项审计 = 菜栏.Controls.Add(Type:=msoControlPopup, Temporary:=True)
    With 菜项审计
        .Caption = "分析审计"
    End With
'========================================================================================
...
'========================================================================================
    ...
    '模块：分析交割单
    '------------------------------------------------------------------------------------
    With 菜项审计.Controls.Add(Type:=msoControlButton)
        .BeginGroup = True
        .Caption = "分析交割单"
        .OnAction = "STCALL割册管理_XLS交割单G0总流程"
        .FaceId = 220
    End With
    With 菜项审计.Controls.Add(Type:=msoControlButton)
        .Caption = "分析交割单G3(跳过文件选择)"
        .OnAction = "STCALL割册管理_XLS交割单G3解析"
        .FaceId = 220
    End With
    '------------------------------------------------------------------------------------
    '模块：组合管理检验
