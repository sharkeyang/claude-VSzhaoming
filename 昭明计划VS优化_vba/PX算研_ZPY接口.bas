...
'   测试_查概率表()           — 验证照明概率.txt加载正确性
'   测试_匹配策略(...)         — 模拟一只股票的周冲策略匹配
'   测试_查概率表调试()        — 逐行显示概率表加载过程
'========================================================================================
Attribute VB_Name = "PX算研_ZPY接口"
Option Explicit

'========================================================================================
' 窄管蓄力 — 日级别回测：窄管中蓄力（DS顶JA≤8）的首轮回测
' 用法：在Excel中运行 Call XL展探窄管蓄力
' 输出：自动新建 "展探窄管蓄力" 工作表
'========================================================================================
Public Sub XL展探窄管蓄力()
...
'========================================================================================
' 测试：模拟一只股票的策略匹配
' 用法：Call 测试_匹配策略 或 Call 测试_匹配策略("金","乙",3,"升.尾连QQ.Q2","","Aa龙猪.初")
'========================================================================================
